      ...
      if(v.value && forge.util.isArray(v.value)) {
        ...
        for(var i = 0; rval && i < v.value.length; ++i) {
          ...
          if(schemaHasTag &&
            ...
            // Tags do not match.
            if(schemaItem.optional) {
              // Skip this schema element (don't consume objChild; don't call
              // recursive validate).
              rval = true;
              continue;
            } else {
          ...
          // Tags are compatible (or schema did not declare tags) - dive into
          // recursive validate.
          ...
          if(childRval) {
            ...
            // validation failed but element is optional => skip schema item
            // (don't consume child)
            rval = true;
          } else {
            // required item failed
            rval = false;
            // errors should already be populated by recursive call; keep
            // failing
            break;
          }
        }
